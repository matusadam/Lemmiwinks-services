...
curl http://0.0.0.0:8080/api/archives -i -H "Content-Type: application/json" -H "Authorization: Token Z0SbdsCkNXgrvQSGXqZWTsd0ylWVJasO" -X POST -d '{"urls" : ["http://www.skibila.cz"], "name" : "SkiBilaLangPL", "forceTor" : false, "headers" : {"Accept-Language":"pl"}}'
